public class UIConstantsMessages {
    ...
    public static String k_IllegalNumOfPlayers = "illegal numofplayers";
    public static String k_IllegalIDOfPlayers = "illegal idofplayers";
}